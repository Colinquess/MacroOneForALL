...
CloudArchive := {RemoteVersion:[CloudQNTArchives],ItsDownloadLink:[CloudQNTArchives]}
...
;############# Remember that the base amount of scripts is 2, so you should ALLWAYS set the CloudQNTArchives to the value of added scrips +2 ########
